=== Plugin Name ===
Contributors: weberge
Donate link: http://www.weberge.com/
Tags: wordpress, Hide, wp-hide
...
WP-Hide, hide all the site related path and details from source so that no programs will get any hint that the site is developed using  WordPress. 
...
Based on these concept we made a plugin 'WP_Hide' which will help you to hide the fact that you are using WordPress for website development. WP-Hide, hide all the site related path and details from source so that no programs will get any hint that the site is developed using  WordPress.  
